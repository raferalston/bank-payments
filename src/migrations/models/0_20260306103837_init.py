...
COMMENT ON COLUMN "order"."payment_status" IS 'NOT_PAID: not_paid\nPARTIALLY_PAID: partially_paid\nPAID: paid';
...
COMMENT ON COLUMN "payment"."payment_type" IS 'CASH: cash\nACQUIRING: acquiring';
COMMENT ON COLUMN "payment"."operation_status" IS 'PENDING: pending\nDEPOSITED: deposited\nREFUNDED: refunded\nFAILED: failed';
